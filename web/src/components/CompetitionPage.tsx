    ...
    <DeepVoidBackground className="py-8">
      <div className="w-full px-4 md:px-8 space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-black/40 border border-white/10 rounded-xl p-6 backdrop-blur-md animate-slide-in hover:border-white/20 transition-colors">
            <div className="flex items-center justify-between mb-6">
        ...
        {competition.traders.length === 2 && (
          <div className="bg-black/40 border border-white/10 rounded-xl p-6 backdrop-blur-md animate-slide-in">
