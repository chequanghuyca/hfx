...
type Data struct {
	...
	LongShortRatio    float64 // Long/Short ratio (e.g. 1.25)
...
type TimeframeSeriesData struct {
	...
	LongShortRatio  []float64 `json:"long_short_ratio,omitempty"` // Long/Short ratio series
	FundingRate     []float64 `json:"funding_rate,omitempty"`     // Funding rate series
}
