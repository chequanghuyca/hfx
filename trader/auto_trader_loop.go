...
func (at *AutoTrader) buildTradingContext() (*kernel.Context, error) {
	...
	for _, pos := range positions {
		...
		// Priority 2: Not applicable for Binance (it uses trader_positions table)
	...
	if at.store != nil {
		// Get recent 20 closed trades for AI context so the model remembers
		// fresh wins/losses and avoids immediately repeating bad symbols.
