...
type Config struct {
	...
	DBSchema   string // PostgreSQL schema used to isolate this installation

	// Security configuration
	// Transport Encryption enables browser-side encryption for API keys
...
func Init() {
	...
	// Initialize telemetry module (installation ID will be set after database init)
